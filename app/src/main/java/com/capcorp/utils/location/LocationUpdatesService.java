...
//import com.capcorp.utils.AppSocket;
...
//                new Intent(this, GetStartedActivity.class), 0);
//
//        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
//                .addAction(R.drawable.ic_transport, getString(R.string.launch_activity),
...
//            liveLocation.setLat(location.getLatitude());
//            liveLocation.setLong(location.getLongitude());
//            liveLocation.setBearing(location.getBearing());
