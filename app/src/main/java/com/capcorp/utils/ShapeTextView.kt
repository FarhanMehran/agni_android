...
class ShapeTextView : AppCompatTextView {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        if (radius == 0f) {
            topLeftRadius =
                typedArray.getDimensionPixelSize(R.styleable.ShapeTextView_topLeftRadius, 0)
                    .toFloat()
            topRightRadius =
                typedArray.getDimensionPixelSize(R.styleable.ShapeTextView_topRightRadius, 0)
                    .toFloat()
            bottomLeftRadius =
                typedArray.getDimensionPixelSize(R.styleable.ShapeTextView_bottomLeftRadius, 0)
                    .toFloat()
            bottomRightRadius =
                typedArray.getDimensionPixelSize(R.styleable.ShapeTextView_bottomRightRadius, 0)
                    .toFloat()
        }
        solidBackgroundColor =
            typedArray.getColor(R.styleable.ShapeTextView_solidBackgroundColor, 0)
        ...
        if (setRippleEnabled && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            rippleColor =
                typedArray.getColor(R.styleable.ShapeTextView_rippleColor, DEFAULT_RIPPLE_COLOR)
        }
        ...
        gradientOrientation = typedArray.getInt(
            R.styleable.ShapeTextView_gradientOrientation,
            GRADIENT_ORIENTATION_LEFT_TO_RIGHT
        )
