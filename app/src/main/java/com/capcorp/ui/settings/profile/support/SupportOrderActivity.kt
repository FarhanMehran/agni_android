...
import kotlinx.android.synthetic.main.activity_support_order.*
import java.io.File

class SupportOrderActivity : BaseActivity(), AccountContract.View, View.OnClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_support_order)
    ...
    fun setListener() {
        ...
        chRefund.setOnCheckedChangeListener(object : CompoundButton.OnCheckedChangeListener {
            override fun onCheckedChanged(p0: CompoundButton?, p1: Boolean) {
                isChecked = p1.toString()
            }
    ...
    fun setViews() {
        ...
        tvOrderName.text = intent.getStringExtra("name")
        tvOderDecription.text = intent.getStringExtra("desc")
        tvOderId.text = intent.getStringExtra("showId")

        if (isCompleted!!) {
            val userType = SharedPrefs.with(this@SupportOrderActivity).getString(USER_TYPE, "")

            if (!userType.equals(UserType.DRIVER))
                li_refund.visibility = View.VISIBLE
            else
                li_refund.visibility = View.GONE
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.tvGetStarted -> {
                if (reasonId.equals("")) {
                ...
                } else if (isChecked.toBoolean() && edt_details.text.toString().isEmpty()) {
                    rootView_support?.showSnack(getString(R.string.enter_dec_msg))
                    ...
                    if (CheckNetworkConnection.isOnline(this)) {
                        ...
                        try {
                            ...
                            supportRequest.orderId = orderID.toString()
                            ...
                            supportRequest.refundIssue = isChecked
